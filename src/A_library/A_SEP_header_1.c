...
void writeHeaderMig (char *filename, char *title, int tg_type, float *tg_o1, float *tg_o2, float *tg_o3,    
                     ...
                     int n2, int n3, char *dataformat, int esize, char *in, int bordf, float *semiap,         
                     ...
                     float *soglia_ampiezze, int imaging, int ava, int muteFlag, char *muteFileName, int datadecimation, 
                     int antialias) 
{
